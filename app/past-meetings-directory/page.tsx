...
export default function PastMeetingsDirectory() {
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(135deg, #001E60 0%, #000000 100%)" }}>
      ...
      <main className="flex flex-col items-center justify-center p-8 min-h-[calc(100vh-80px)]">
        <h1 className="text-4xl font-bold text-white">Past Meetings Directory</h1>
        <p className="mt-6 text-center max-w-xl text-white/80">Placeholder page for Past Meetings Directory. Content coming soon.</p>
      </main>
    </div>
  );
}
