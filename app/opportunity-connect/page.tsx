...
export default function OpportunityConnect() {
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(135deg, #001E60 0%, #000000 100%)" }}>
      ...
      <main className="flex flex-col items-center justify-center p-8 min-h-[calc(100vh-80px)]">
        <h1 className="text-4xl font-bold text-white">Opportunity Connect</h1>
        <p className="mt-6 text-center max-w-xl text-white/80">Placeholder page for Opportunity Connect. Content coming soon.</p>
      </main>
    </div>
  );
}
